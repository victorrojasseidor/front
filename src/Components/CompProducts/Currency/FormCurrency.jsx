                  ...
                  <div className="box-filter">
                    ...
                    <FormControl sx={{ m: 1, minWidth: 180 }}>
                      ...
                      <Select
                        ...
                        IconComponent={IconArrow}
                        onChange={(values) => {
                          handlePortalChange(values);
                          setFieldValue('fuente', values.target.value);
                        }}
                      >
                    ...
                    <FormControl sx={{ m: 1, minWidth: 180 }}>
                      ...
                      <Select
                        ...
                        IconComponent={IconArrow}
                        onChange={(values) => {
                          handleCoinOriginChange(values);
                          setFieldValue('coinOrigin', values.target.value);
                        }}
                      >
                    ...
                    <FormControl sx={{ m: 1, minWidth: 180 }}>
                      ...
                      <Select
                        ...
                        IconComponent={IconArrow}
                        onChange={(values) => {
                          handleCoinDestinyChange(values);
                          setFieldValue('coinDestiny', values.target.value);
                        }}
                      >
                        {dataTypeChange?.oMoneda.map((option) => (
                          <MenuItem key={option.id_moneda} value={option.id_moneda}>
                ...
                <div className="box-filter">
                  <FormControl sx={{ m: 1, minWidth: 80 }}>
                    ...
                    <Select
                      ...
                      IconComponent={IconArrow}
                      onChange={(values) => {
                        handleDaysChange(values);
                        setFieldValue('days', values.target.value);
                      }}
                    >
