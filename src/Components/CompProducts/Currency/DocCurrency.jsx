          ...
          <div className="tabOne currency ">
            <div className="currency_features">
              <div className="description">
                <p>
                  The fastest and safest way to have the <span> exchange rate </span>registered in your ERP every day.
                </p>
              ...
              <div className="currency_benefits">
                ...
                <div>
                  <ul>
                    ...
                    <p>
                      <li> Protect your information systems by avoiding errors and delays in sensitive data and exchange rates.</li>
                    </p>
                  </ul>
