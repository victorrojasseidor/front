...
const Principal = () => {
  ...
  useEffect(() => {
    // intervalos de cambio de imágenes de front
          ...
          <div className="container-advantages">
            <div className="box-advantage">
              ...
              <div className="advantage end-direction" data-aos="zoom-out-up">
                ...
                <p className="advantage-description">{t['Advanced security, encrypted passwords, secure access management, exclusive database per client, segregated roles and functions']}</p>
              </div>
            </div>
