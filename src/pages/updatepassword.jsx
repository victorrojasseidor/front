...
const SignupSchema = Yup.object().shape({
  ...
  password: Yup.string().min(8, 'Password must be at least 8 characters').required('The password is required'),
            ...
            {({ isSubmitting }) => (
              <form className="form">
                ...
                <div>
                  ...
                  <Field type={showPassword ? 'text' : 'password'} name="confirmPassword" value={password} onChange={handlePasswordChange} />
                  <FontAwesomeIcon className="iconPassword" icon={showPassword ? faEyeSlash : faEye} onClick={togglePasswordVisibility} />
